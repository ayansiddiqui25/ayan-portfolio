    ...
    <main className="game-shell">
      ...
      <div className="stadium" aria-hidden="true">
        ...
        <div className="ad-board">
          ...
          <span>Pixel Portfolio FC</span>
          <span>Play the next move</span>
        </div>
        <div className="pitch" />
      </div>
      ...
      <section className="game-stage" aria-label="Interactive penalty kick navigation">
        ...
        <div className="intro-card">
          <span className="intro-card__eyebrow">Welcome to my portfolio</span>
          <h1>Pick a corner.</h1>
          <p>
            I design and build digital experiences. Take the penalty to choose
            where the story starts.
          </p>
          <div className="intro-card__prompt">Select any goal zone</div>
        </div>
      </section>
